#!/usr/bin/env python3
"""
Simple mTLS Test Server
A basic HTTPS server with mTLS for testing registration with MCP Proxy.
...
async def main():
    """Main function."""
    logger.info("🚀 Starting Simple mTLS Server")
    logger.info("=" * 60)
