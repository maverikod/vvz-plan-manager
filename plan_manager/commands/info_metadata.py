...
def get_info_metadata(cls) -> Dict[str, Any]:
    ...
    return {
        ...
        "detailed_description": (
            ...
            "invariants, and stable domain error codes. The "
            "runtime_work_layer capability group documents the wish and "
            "calendar-entry families in detail: WishItem records a feature "
            "desire awaiting an acceptance decision (statuses proposed/"
            "triaged/planned/in_progress/delivered/rejected/cancelled, kinds "
            "feature/ux/automation/integration/reporting/tooling/other, "
            "nice-scale priority, transitive project filtering, active_only "
            "and unanchored_only views), and CalendarEntry schedules dated "
            "work windows over inclusive YYYY-MM-DD calendar-day spans with "
            "day-window list filtering, an optional link to the wish being "
            "realized, and one validated primary anchor over the shared "
            "runtime anchor vocabulary; neither entity ever enters "
            "todo_queue, and every mutation is audited. The step_lifecycle "
            ...
            "success": {
                ...
                "data": {
                    ...
                    "capabilities": (
                        ...
                        "catalog visibility, prompt-chain compilation, the "
                        "runtime work layer (wish desires and calendar-entry "
                        "scheduling), read surfaces, import/export behavior, "
