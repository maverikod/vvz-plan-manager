"""Command: move a wish item's primary anchor to a new target, with an audit record (group-3 fix, bug 2c568c0c)."""
...
class WishReanchorCommand(Command):
    name: ClassVar[str] = "wish_reanchor"
    version: ClassVar[str] = "1.0.0"
    descr: ClassVar[str] = "Move a wish item's primary anchor to a new target, with an audit record."
    ...
    def get_schema(cls) -> dict[str, Any]:
        return {
            "type": "object",
            "properties": {
                "wish": {"type": "string", "format": "uuid", "description": "Wish item UUID to re-anchor."},
            ...
            "required": ["wish", "changed_by", "new_anchor_type"],
    ...
    def metadata(cls) -> dict[str, Any]:
        ...
        return wish_metadata(
            cls,
            params,
            {"success": {"description": "The re-anchored WishItem payload."}},
            [{"description": "Move a wish's anchor to a step.", "command": {"wish": "11111111-1111-1111-1111-111111111111", "changed_by": "agent-1", "new_anchor_type": "step", "new_anchor_plan_uuid": "22222222-2222-2222-2222-222222222222", "new_anchor_step_uuid": "33333333-3333-3333-3333-333333333333"}}],
            error_cases=REANCHOR_ERROR_CASES,
            best_practices=REANCHOR_BEST_PRACTICES,
        )

    _UUID_FIELDS: ClassVar[tuple[str, ...]] = (
        "wish", "new_anchor_project_id", "new_anchor_plan_uuid",
        "new_anchor_revision_uuid", "new_anchor_step_uuid", "new_anchor_ref_id",
    )

    def validate_params(self, params: dict[str, Any]) -> dict[str, Any]:
        """Validate wish_reanchor parameters beyond the base schema check: wish and
        every UUID-shaped new_anchor_* field, when supplied, must parse as a UUID.

        Raises:
            InvalidParamsError: If wish or any new_anchor_* UUID field is not a
                valid UUID string.
        """
        ...
        try:
            ...
            with db_connection() as conn:
                ...
                if confirmation.confirmed:
                    ...
                    # persist an unverified project/file anchor -- move the wish to
