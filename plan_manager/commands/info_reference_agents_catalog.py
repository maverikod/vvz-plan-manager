...
def crud_matrix() -> dict[str, Any]:
    ...
    return {
        ...
        "entities": {
            ...
            "bug_fix": {"create": "bug_fix_create", "read": "bug_fix_list", "update": "bug_fix_update/bug_fix_verify", "delete": "bug_fix_delete (soft by default: recoverable, hidden from listings; hard=true irreversible; both modes gated by the inbound-reference integrity check - live anchored comments, execution attempts, or bug-fix propagations refuse with DELETE_BLOCKED; dry_run previews references)"},
            "bug_fix_propagation": {"create": "bug_propagation_create", "read": "bug_propagation_list", "update": "bug_propagation_update", "delete": "bug_fix_propagation_delete (soft by default: recoverable, hidden from listings; hard=true irreversible; a leaf entity, so hard delete is normally unblocked; dry_run previews references)"},
...
_COMMAND_CATEGORIES: dict[str, list[str]] = {
    ...
    "graph": [
        "graph_deps", "graph_order", "graph_parallel_map", "graph_impact", "graph_dependents",
        "execution_graph", "execution_dependency_suggest", "execution_dependency_apply",
    ],
    "step_dependency": [
    ...
    "reference": ["reference_inspect", "id_resolve", "reference_repair"],
    "todo": [
    ...
    "bug_impact": ["bug_impact_add", "bug_impact_update", "bug_impact_list", "bug_impact_discover", "bug_impact_delete"],
    "bug_fix": ["bug_fix_create", "bug_fix_update", "bug_fix_list", "bug_fix_verify", "bug_fix_delete"],
    "bug_propagation": [
