...
class ProviderListCommand(Command):
    ...
    def metadata(cls) -> dict[str, Any]:
        ...
        return_value = {
            "description": "An object with a providers key holding a page of Provider records, plus total/limit/offset.",
            "type": "object",
        }
        examples = [
        ...
        try:
            with db_connection() as conn:
                ...
                return SuccessResult(data={
                    "providers": [provider.to_payload() for provider in page],
                    "total": total,
